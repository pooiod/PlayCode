...
self.addEventListener("install", (e) => {
  e.waitUntil(
    ...
    caches.open("code-playground-cache").then((cache) => {
      // Cache the homepage and stylesheets - add any assets you want to cache!
      return cache.addAll(["index.html", "editor.css", "https://pooiod7.neocities.org/projects/CODE-Playground/lang.js", "https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.12/ace.js"]);
    })
  );
});
